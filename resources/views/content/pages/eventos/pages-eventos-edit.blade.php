      ...
      <form action="{{ route('eventos.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
          ...
          <div class="action-btns">
            @isset($evento)
            <a href="{{ route('eventos.edit', ['evento' => $evento->codigo]) }}" class="btn btn-primary">Editar</a>
            @endisset
            <div class="action-btns">
              ...
              <fieldset class="border p-4 mb-5">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" id="descripcion" name="descripcion" class="form-control phone-mask" required/>
                  </div>
                  <div class="col-md-6">
...
="modalidad" name="modalidad" class="select2 form-select" data-allow-clear="true">
