            ...
            <fieldset class="border p-4 mb-5">
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input type="text" id="identificacion" name="identificacion" class="form-control phone-mask" />
                  </div> 
                  <div class="col-md-6">
                    <label class="form-label" for="codigo">Código</label>
                    <input type="text" id="codigo" name="codigo" class="form-control phone-mask" />
                  </div> 
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <select id="genero" name="genero" class="select2 form-select" data-allow-clear="true">
                      <option value="WI">Selecciona genero</option>
                      <option value="WI">Femenino</option>
                      <option value="WY">Masculino</option>
                    </select>
                  </div>
                  <div class="col-12">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control phone-mask" />
                  </div>
            ...
            <fieldset class="border p-4 mb-5">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                      ...
                      <input type="text" id="programa_academico" name="programa_academico" class="form-control phone-mask" />
                    </div> 
                    <div class="col-md-6">
                      <label class="form-label" for="semestre">Semestre</label>
                      <input type="number" id="semestre" name="codigo" class="form-control phone-mask" />
                    </div>  
                </div>
            </fieldset>
            <fieldset class="border p-4 mb-5">
